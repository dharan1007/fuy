...
const MOCK_ITEMS: ShopItem[] = [
  ...
  {
    id: '3',
    name: 'Theme Pack - Midnight',
    description: 'Dark theme cosmetics',
    price: 400,
    category: 'Themes',
    icon: '🌙',
    purchased: false,
  ...
  {
    id: '4',
    name: 'Emoji Pack - Vibes',
    description: 'Exclusive emoji stickers',
    price: 200,
    category: 'Stickers',
    icon: '✨',
    purchased: false,
  },
  {
    id: '5',
    name: 'Sound Pack - Zen',
    description: 'Calming notification sounds',
    price: 250,
    category: 'Sounds',
    icon: '🎵',
    purchased: false,
