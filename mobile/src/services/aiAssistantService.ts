...
export interface TodoItem {
  ...
  category: string;
  completed: boolean;
  relatedTo?: string; // routine id or feature
}
...
What would you like to do? Feel free to ask me anything, and I'll do my best to help! 🌟`;
  ...
  /**
   * Parse routine request from user message
   */
  private parseRoutineRequest(message: string): Partial<MorningRoutine> {
    // Extract wake time if mentioned
  ...
  /**
   * Generate default routine tasks
   */
  ...
  /**
   * Parse todo request from user message
   */
