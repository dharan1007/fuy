        ...
        <View className="flex-1" style={{ backgroundColor: colors.background }}>
            <SafeAreaView className="flex-1">
                <View className="px-6 py-4 flex-row items-center gap-4 border-b border-gray-800">
                    ...
                    <Text className="text-xl font-bold" style={{ color: colors.text }}>Community Guidelines</Text>
                </View>
                <ScrollView className="flex-1 p-6">
                    <Text style={{ color: colors.text, lineHeight: 24, fontSize: 16 }}>
                        [Mobile Community Guidelines Content Placeholder - Please paste content here]
                    </Text>
                </ScrollView>
            </SafeAreaView>
        </View>
