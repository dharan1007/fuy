        ...
        <Card minimal>
          <div className="flex items-center justify-between mb-3">
            ...
            <div className="flex items-center gap-2">
              ...
              <IconButton title="Export PNG" onClick={exportPNG}>🖼️</IconButton>
          ...
          >
            ...
            {selected && selected.side === side && (
              ...
              >
                ...
                <IconButton title="Cycle quality" onClick={() => updateSelected({ quality: nextQuality(selected.quality) })}>🎛️</IconButton>
