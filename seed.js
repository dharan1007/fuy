    ...
    if (createdUsers.length >= 2) {
        ...
        for (let i = 2; i < createdUsers.length; i++) {
            try {
                ...
                console.log(`✓ Created friendship between ${baseUser.name} and ${createdUsers[i].name}`);
            }
            catch (error) {
        ...
        try {
            await prisma.post.create({
                data: {
                    ...
                    content: "Just completed an amazing 15km route through the city! The new route-planning features are incredible. 🗺️",
                    feature: "AWE",
                    visibility: "PUBLIC",
                    joyScore: 8,
                    creativityScore: 7,
            ...
            await prisma.post.create({
                data: {
                    ...
                    content: "Discovered an amazing café while exploring. The photos feature makes it so easy to document my favorite places! 📸",
                    feature: "JOY",
                    visibility: "PUBLIC",
                    joyScore: 9,
                    connectionScore: 6,
